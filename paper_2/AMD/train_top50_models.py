...
def main():
    parser = argparse.ArgumentParser(description='Entrenar modelos Top50 ICD-10')
    ...
    if 'rnn' in models_to_train:
        ...
        save_path = Path(args.output) / 'simplernn_model_top50.pth'
    ...
    if 'lstm' in models_to_train:
        ...
        save_path = Path(args.output) / 'lstm_model_top50.pth'
    ...
    if 'bilstm' in models_to_train:
        ...
        save_path = Path(args.output) / 'bilstm_model_top50.pth'
    ...
    if 'bert' in models_to_train:
        ...
        save_path = Path(args.output) / 'bert_model_top50.pth'
